...
export default function CitizenDashboardPage() {
  ...
  return (
    <DashboardLayout>
      <PageHeader title={`Welcome, ${mockUserProfile.name}!`} subtitle="Manage your e-waste pickups and track your contributions." />
      
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3 mb-8">
        <StatCard icon={<Star className="h-5 w-5" />} title="Your Credits" value={mockUserProfile.credits ?? 0} color="text-yellow-500" />
